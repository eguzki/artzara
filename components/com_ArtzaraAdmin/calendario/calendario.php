...
function mostrar_calendario($mes,$ano){
	global $parametros_formulario,$raiz;
	...
	echo "<a style=color:white;text-decoration:none href=$raiz?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	...
	echo "<a style=color:white;text-decoration:none href=$raiz?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
...
echo "
	...
	<tr><form action=\"$raiz?$parametros_formulario\" method=\"POST\">";
echo '
